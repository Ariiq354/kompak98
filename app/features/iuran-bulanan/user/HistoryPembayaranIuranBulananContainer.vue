...
import ModalBayarHistoryBulanan from "./components/ModalBayarHistoryBulanan.vue";
import { historyColumn } from "./constants";
...
function clickPayment(id: number, nominal: number) {
  openModal(ModalBayarHistoryBulanan, { id, nominal });
}
</script>
